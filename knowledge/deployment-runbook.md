...
## 서버 정보 (server-info)
<!-- akela: scope=deploy,known-issue-triage tier=should -->
...
<!-- akela: scope=deploy,known-issue-triage tier=must -->
...
## 등록된 systemd 유닛
<!-- akela: scope=deploy tier=should -->
